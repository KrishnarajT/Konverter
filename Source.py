# # # We will be making a GUI Application called ofcourse Konverter that converts files. We will start with basics.
# # # First we add a Menu Screen Displaying the name of the program and asking the user what they wanna convert.
# # # Today we are doing Video to Audio.
# # # We will keep it as simple as we can, but it has to work.
